...
public class OAuth2IssuerServiceImpl implements OAuth2IssuerService {
  ...
  OAuth2IssuerServiceImpl(
    ...
    this.authServer = getResolvedAuthServer(authServer);
    this.restTemplate = restTemplate;
  }

  public void retrieveIssuer() {
    ResponseEntity<HashMap> authResponse = restTemplate.getForEntity(authServer, HashMap.class);
  ...
  private static URI getResolvedAuthServer(String authServer) throws URISyntaxException {
